...
Please contact the OpenWIS Community Manager via [email](mailto:contact@openwis.io) to request that your GitHub name to be removed from the website if you no longer wish to contribute to products owned or managed by the OpenWIS Association AISBL.
...
You agree and acknowledge that the OpenWIS Association AISBL and its licensees may sublicense and distribute your Contributions under any subsequent version of the license specified for the OpenWIS® Project to which your Contribution was made. Furthermore, You agree that, by approval of the [OpenWIS Steering Committee]( {{"/structure/steering-committee.html" | prepend: site.baseurl}} ), an OpenWIS® Project may change the license (and this CLA) from time to time to an alternative open source license from the list maintained by the OSI in order to suit the evolution of the Project.  A [history of approved CLAs]( {{"/static/CLA/CLAhistory.html" | prepend: site.baseurl}} ) is available.
