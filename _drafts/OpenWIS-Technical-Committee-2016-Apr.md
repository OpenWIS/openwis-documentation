...
14th April 2016 - Teleconference
...
7. > _A-OWIS-TC-2016-31 UKMO - PN: ask the UKMO OpenAM team if there are any schema changes to worry about._
...
9. > _A-OWIS-TC-2016-32 MF - RG: Put the configuration script onto GitHub._
...
14. > _BoM WQ: Ok, so we are agreed, we will release v 3.14.5 with Java 7.0.19 and patch it in a later release._
...
2. UKMO PR: We have a lot of the changes for v 4 ready, but we need to sort out the issue with harvesting to be able to test it properly.  We hope to do that in June.
3. > _A-OWIS-TC-2016-33 BoM/UKMO - LM/PR: draft a backlog for the next TC._
...
7. > _A-OWIS-TC-2016-34 BoM LM: Provide some developer docs on how to set up the development environment using a combination of vagrant and puppet._
